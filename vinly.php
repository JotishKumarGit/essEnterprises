      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-6 mt-4 mt-md-0 wow fadeInUp" data-wow-delay="0.5s">
          <h1 class="fw-bold text-dark mb-3">
            Stylish – Durable, Modern, Practical
            <span class="text-primary">Vinyl Flooring</span>
          </h1>
          <h5 class="text-muted mb-3">
            Perfect for homes, offices, and commercial spaces — combine
            aesthetics with long-lasting performance.
          </h5>

          <p class="text-secondary">
            Our vinyl flooring is crafted using high-quality materials to
            provide durability, easy maintenance, and a premium look.
            Available in a wide range of textures, colors, and designs, it’s
            ideal for creating modern, elegant, and functional flooring
          ...
          <ul class="list-unstyled">
            ...
            <li>✔ Water & Scratch Resistant</li>
            <li>✔ Easy to Clean & Maintain</li>
            <li>✔ Wide Range of Designs & Textures</li>
