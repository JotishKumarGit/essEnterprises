      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-6 mt-4 mt-md-0 wow fadeInUp" data-wow-delay="0.5s">
          <h1 class="fw-bold text-dark mb-3">
            Modern – Stylish, Functional, Elegant
            <span class="text-primary">False Ceilings</span>
          </h1>
          <h5 class="text-muted mb-3">
            Enhance interiors with contemporary designs — ideal for homes,
            offices, and commercial spaces.
          </h5>

          <p class="text-secondary">
            Our false ceilings are designed to combine aesthetics with
            functionality. Crafted using high-quality materials, they provide
            insulation, noise reduction, and easy maintenance, while giving
            any space a modern and elegant look. Perfect for residential,
            corporate, and commercial interiors.
          </p>

          <h6 class="fw-bold mt-4">Key Features:</h6>
          <ul class="list-unstyled">
            <li>✔ Stylish & Modern Designs</li>
            <li>✔ Durable & Long-Lasting</li>
            <li>✔ Easy Installation & Maintenance</li>
            <li>✔ Acoustic & Thermal Benefits</li>
